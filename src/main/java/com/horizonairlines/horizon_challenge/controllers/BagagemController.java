...
public class BagagemController {
    ...
    // @PostMapping
    // public ResponseEntity<PassagemDTO> save(@RequestBody PassagemInputDTO
    // passagemInputDTO) {
    ...
    // public ResponseEntity<EtiquetaDTO> voucher(@PathVariable Integer numero) {
    // var result = bagagemService.printEtiqueta(numero);
    // return ResponseEntity.status(HttpStatus.OK).body(result);
    // }

    @GetMapping
    public ResponseEntity<EtiquetaDTO> etiqueta(@RequestParam Integer numero) {
        var result = bagagemService.printEtiqueta(numero);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
